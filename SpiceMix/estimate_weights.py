...
def estimate_weight_wnbr(
		Y, M, X, sigma_yx, Sigma_x_inv, E, prior_x_mode, prior_x, context, n_epochs=1000, tol=1e-5, update_alg='gd',
):
	"""
	...
	def update_z_gd(Z):
		...
		for idx in IndependentSet(E_adj_list, batch_size=128):
			...
			while True:
				...
				project2simplex(Z_batch_new, dim=1)
