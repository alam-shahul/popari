...
def spicemix_with_neighbors():
    ...
    for iteration in range(1, 5):
        ...
        obj.estimate_weights(iiter=iteration, use_spatial=[True]*obj.num_repli, backend_algorithm="gd")
...
def test_Sigma_x_inv(spicemix_with_neighbors):
    ...
    # np.save("../tests/test_data/synthetic_500_100_20_15_0_0_i4/outputs/Sigma_x_inv_with_neighbors_gd.npy", Sigma_x_inv)
    test_Sigma_x_inv = np.load("../tests/test_data/synthetic_500_100_20_15_0_0_i4/outputs/Sigma_x_inv_with_neighbors_gd.npy")
...
def test_M(spicemix_with_neighbors):
    ...
    # np.save("../tests/test_data/synthetic_500_100_20_15_0_0_i4/outputs/M_with_neighbors_gd.npy", M)
    test_M = np.load("../tests/test_data/synthetic_500_100_20_15_0_0_i4/outputs/M_with_neighbors_gd.npy")
    assert np.allclose(test_M, M)
    
def test_X_0(spicemix_with_neighbors):
    X_0 = spicemix_with_neighbors.Xs[0].detach().cpu().numpy()
    # np.save("../tests/test_data/synthetic_500_100_20_15_0_0_i4/outputs/X_0_with_neighbors_gd.npy", X_0)
    test_X_0 = np.load("../tests/test_data/synthetic_500_100_20_15_0_0_i4/outputs/X_0_with_neighbors_gd.npy")
...
def test_louvain_clustering(spicemix_with_neighbors):
    ...
    print(ari)
    assert 0.3587061110450239 == pytest.approx(ari)
        
    silhouette = silhouette_score(x, df_meta['cell type'])
    print(silhouette)
    assert 0.03157355636358261  == pytest.approx(silhouette)
