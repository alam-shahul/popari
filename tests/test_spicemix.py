...
def test_Sigma_x_inv_no_neighbors(spicemix_without_neighbors):
    ...
    np.save("../tests/test_data/synthetic_500_100_20_15_0_0_i4/outputs/Sigma_x_inv_no_neighbors.npy", Sigma_x_inv)
...
def test_M_no_neighbors(spicemix_without_neighbors):
    ...
    np.save("../tests/test_data/synthetic_500_100_20_15_0_0_i4/outputs/M_no_neighbors.npy", M)
...
def test_X_0_no_neighbors(spicemix_without_neighbors):
    ...
    np.save("../tests/test_data/synthetic_500_100_20_15_0_0_i4/outputs/X_0_no_neighbors.npy", X_0)
