...
def shared_model_factory(context, adata_factory):
    def factory(**overrides):
        ...
        return Popari(
            ...
            groups=overrides.pop("groups", None),
            regularization_groups=overrides.pop("regularization_groups", None),
...
def differential_model_factory(context, adata_factory):
    def factory(**overrides):
        ...
        return Popari(
            ...
            sample_key=sample_key,
            lambda_Sigma_x_inv=overrides.pop("lambda_Sigma_x_inv", 1e-3),
            groups=overrides.pop("groups", "disjoint"),
            regularization_groups=overrides.pop(
                "regularization_groups",
                {"_default": list(adata.popari.sample_names)},
            ),
