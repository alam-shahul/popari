...
def test_Sigma_x_inv(popari_with_neighbors):
    ...
    np.save("tests/test_data/synthetic_dataset/outputs/Sigma_x_inv_shared.npy", Sigma_x_inv)
    test_Sigma_x_inv = np.load("tests/test_data/synthetic_dataset/outputs/Sigma_x_inv_shared.npy")
...
def test_M(popari_with_neighbors):
    ...
    np.save("tests/test_data/synthetic_dataset/outputs/M_bar_shared.npy", M_bar)
    test_M = np.load("tests/test_data/synthetic_dataset/outputs/M_bar_shared.npy")
...
def test_X_0(popari_with_neighbors):
    ...
    np.save("tests/test_data/synthetic_dataset/outputs/X_0_shared.npy", X_0)
    test_X_0 = np.load("tests/test_data/synthetic_dataset/outputs/X_0_shared.npy")
