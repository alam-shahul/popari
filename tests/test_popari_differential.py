...
def test_Sigma_x_inv(popari_with_neighbors):
    ...
    # jnp.save("tests/test_data/synthetic_500_100_20_15_0_0_i4/outputs/Sigma_x_inv_differential.npy", Sigma_x_inv)
...
def test_louvain_clustering(popari_with_neighbors):
    ...
    path2dataset = Path('tests/test_data/synthetic_500_100_20_15_0_0_i4')
    repli_list = [0, 1]
    expected_aris = [0.7283884171813543, 0.6780724762927413]
