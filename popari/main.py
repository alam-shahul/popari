...
def parse_arguments():
    ...
    parser.add_argument(
        "--repli_list",
        type=lambda x: list(map(str, eval(x))),
    ...
    parser.add_argument("--lambda_x", type=float, default=1.0, help="Prior of X")
    ...
    parser.add_argument(
        "--result_filename",
        default=None,
        help="The name of the h5 file to store results",
    )
...
if __name__ == "__main__":
    ...
    obj = SpiceMixPlus(
        K=args.K,
        lambda_Sigma_x_inv=args.lambda_Sigma_x_inv,
